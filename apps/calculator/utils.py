...
def analyze_image(img: Image, dict_of_vars: dict):
    ...
    f"Note: the answers can be up to 5 decimal points"
    ...
    f"Note : only calculated answer with the expression "
    ...
    f"* When solving mathematical expressions, make sure to follow the order of operations (PEMDAS). "
    f"* When solving equations, make sure to check for multiple solutions and handle them accordingly. "
    f"* When analyzing graphical math problems, pay close attention to different colors and use relevant formulas to solve the problem. "
    f"* When detecting abstract concepts, use your knowledge of history, literature, and culture to provide a accurate answer. "
